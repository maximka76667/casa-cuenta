...
def add_expense(expense: ExpenseCreate):
    ...
    new_expense = {"name": expense.name, "amount": expense.amount, "payer_id": expense.payer_id, "group_id": expense.group_id}
    ...
    return {"message": "Expense added", "expense": expense_response.data[0], "debtors": response.data}
